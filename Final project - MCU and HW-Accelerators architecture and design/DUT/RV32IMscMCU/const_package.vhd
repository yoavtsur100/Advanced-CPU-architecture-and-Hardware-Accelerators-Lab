...
CONSTANT MMIO_ADDR_WIDTH_C : INTEGER := 14;

CONSTANT PORT_LEDR_ADDR_C :
    STD_LOGIC_VECTOR(MMIO_ADDR_WIDTH_C-1 DOWNTO 0)
    := "10" & X"000";                         -- 0x2000

CONSTANT PORT_HEX0_ADDR_C :
    STD_LOGIC_VECTOR(MMIO_ADDR_WIDTH_C-1 DOWNTO 0)
    := "10" & X"004";                         -- 0x2004

CONSTANT PORT_HEX1_ADDR_C :
    STD_LOGIC_VECTOR(MMIO_ADDR_WIDTH_C-1 DOWNTO 0)
    := "10" & X"005";                         -- 0x2005

CONSTANT PORT_HEX2_ADDR_C :
    STD_LOGIC_VECTOR(MMIO_ADDR_WIDTH_C-1 DOWNTO 0)
    := "10" & X"008";                         -- 0x2008

CONSTANT PORT_HEX3_ADDR_C :
    STD_LOGIC_VECTOR(MMIO_ADDR_WIDTH_C-1 DOWNTO 0)
    := "10" & X"009";                         -- 0x2009

CONSTANT PORT_HEX4_ADDR_C :
    STD_LOGIC_VECTOR(MMIO_ADDR_WIDTH_C-1 DOWNTO 0)
    := "10" & X"00C";                         -- 0x200C

CONSTANT PORT_HEX5_ADDR_C :
    STD_LOGIC_VECTOR(MMIO_ADDR_WIDTH_C-1 DOWNTO 0)
    := "10" & X"00D";                         -- 0x200D

CONSTANT PORT_SW_ADDR_C :
    STD_LOGIC_VECTOR(MMIO_ADDR_WIDTH_C-1 DOWNTO 0)
    := "10" & X"010";                         -- 0x2010
