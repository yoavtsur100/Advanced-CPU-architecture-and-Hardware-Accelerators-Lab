...
--==================================================================================================================
	...
	--Extension because 3 Clocks PLL uses:
	
	constant G_MCLK_PLL_DIV             : NATURAL   := 2;
	constant G_MCLK_PLL_MUL             : NATURAL   := 1; -- 25 MHz (period 40 ns, slack will close positive with STANDARD FIT)
	
	constant G_ACCELCLK_PLL_DIV         : NATURAL   := 1;
	constant G_ACCELCLK_PLL_MUL         : NATURAL   := 2; -- 100 MHz 

	constant G_SMCLK_PLL_DIV            : NATURAL   := 2;
	constant G_SMCLK_PLL_MUL            : NATURAL   := 1; -- 25 MHz
